...
**How to apply:** Preserve artwork-first ordering through preview chaining, paid edits, reset-to-original, and multi-image provider calls. Keep exact title and artist instructions in the composed prompt, and retain existing entitlement, private-storage, allowance, watermark, and failure boundaries.