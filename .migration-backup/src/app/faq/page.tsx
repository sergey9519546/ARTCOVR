...
import { serializeJsonLd } from "@/lib/artcovr/seo";
...
const questions = [
  ...
  ["What do preview and purchase access include?", "Before purchase, each account can create up to two successful 1024 × 1024 px watermarked previews per artwork. A completed purchase includes the native base artwork, your selected preview when present, and up to four successful 2048 × 2048 px purchased generations. Generation and signed-download access last 30 days from verified payment. Delivery is digital-only through My Images; nothing is shipped."],
  ["Will the native artwork meet my platform's requirements?", "ARTCOVR delivers the base artwork at the native dimensions and format shown on its artwork page without upscaling. Confirm your destination's current pixel and file-format requirements before purchase."],
  ...
  ["How are refund requests handled?", "Refund requests are reviewed by the owner within a reasonable period. Approved refunds revoke the commercial license for the refunded artwork and disable unused generations and download links."],
