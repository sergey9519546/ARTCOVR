  ...
  useEffect(() => {
    const updateCount = () => {
      try {
        ...
        setBagCount(Array.isArray(b) ? b.length : 0);
      } catch {
        setBagCount(0);
      }
    };
