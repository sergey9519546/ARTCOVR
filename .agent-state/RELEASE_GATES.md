...
| Gate | Requirement | Command / Check | Status (2026-08-16) |
| :--- | :--- | :--- | :--- |
...
| **G6: Catalog Integrity** | Projection matches approved records | `npm run catalog:project:check` | **PASS** (169 approved → 139 projected, 30 delete-tier excluded, `launchCountValid: true`) |
