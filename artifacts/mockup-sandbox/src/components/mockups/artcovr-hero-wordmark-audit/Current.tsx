...
export function Current() {
  return (
    <main className="min-h-screen" id="audit-canvas">
        ...
        <div className="mt-26 mb-6">
          ...
          >
            ...
            <div className="col-span-5 md:col-span-8">
              ...
              >
                Select an artwork, describe any change in one freeform prompt,
                and keep iterating from the visible result. Purchase the
                direction you want and download your images.
              </p>
            </div>
            <div className="col-span-3 flex h-full flex-col justify-between md:col-span-3">
              <div>
                ...
                <p className="mt-4 text-[11px] font-bold uppercase tracking-[.12em] opacity-60">
                  Secure Stripe checkout · Commercial license included ·
