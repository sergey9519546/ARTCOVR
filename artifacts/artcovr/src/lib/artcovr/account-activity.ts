...
export function generationHistoryLabel(generation: Pick<AccountGeneration, "phase" | "prompt">): string {
  return generation.prompt?.trim() || (generation.phase === "preview" ? "Generated preview" : "Generated edit");
}
